...
public class CommandProcessorTest {
	...
	@Test
	public void verifyInvalidTripCount()	{
		
		commands.add("Trip Alpha 06:00 07:00 4.9");
		commands.add("Trip Alpha 06:00 07:00 5.1");
		commands.add("Trip Alpha 06:00 07:00 100.1");
		commands.add("Trip Alpha 06:00 07:00 99.9");
		
		Map<String, Driver> allDrivers = processor.processCommand(commands);
		Driver alpha = allDrivers.get("Alpha");
		
		Assert.assertEquals(2, alpha.getInvalidTrips());
